...
- Workspace folder is user managed. It is where user keeps and organizes their notes. It is not touched by any operator unless explicitly asked by the user.
- Agentic work is stored in
